...
class EliminarComics extends StatefulWidget {
  @override
  _EliminarComicsState createState() => _EliminarComicsState();
}

class _EliminarComicsState extends State<EliminarComics> {
  ...
  Future<void> _cargarArticulos() async {
    try {
      final QuerySnapshot snapshot = await FirebaseFirestore.instance.collection('comics').get();
      setState(() {
            ...
            TextButton(
              ...
              onPressed: () async {
                try {
                  ...
                  await FirebaseFirestore.instance.collection('comics').doc(id).delete();
