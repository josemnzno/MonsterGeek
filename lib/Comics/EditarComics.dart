...
class EditarComics extends StatefulWidget {
  @override
  _EditarAutoState createState() => _EditarAutoState();
}

class _EditarAutoState extends State<EditarComics> {
        ...
        return AlertDialog(
          ...
          actions: <Widget>[
            ...
            TextButton(
              ...
              onPressed: () async {
                try {
                  await FirebaseFirestore.instance.collection('comics').doc(articulo['id']).update({
