...
void main() async {
  ...
  runApp(Agregarfigura());
}

class Agregarfigura extends StatelessWidget {
  @override
...
class _AgregarFiguraState extends State<AgregarFigura> {
  ...
  String _marcaSeleccionada = 'Funko'; // Valor por defecto
  ...
  Future<String?> _subirImagen() async {
    ...
    try {
      ...
      final storageRef = FirebaseStorage.instance
          .ref()
          .child('imagenes_figuras/${DateTime.now().toString()}');
  ...
  void _guardarArticulo() async {
    ...
    try {
      ...
      await FirebaseFirestore.instance.collection('figuras').add({
