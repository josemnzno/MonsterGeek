...
class EditarFigura extends StatefulWidget {
  @override
  _EditarFiguraState createState() => _EditarFiguraState();
}

class _EditarFiguraState extends State<EditarFigura> {
  ...
  Future<void> _cargarArticulos() async {
    try {
      final QuerySnapshot snapshot = await FirebaseFirestore.instance.collection('figuras').get();
      setState(() {
        ...
        return AlertDialog(
          ...
          actions: <Widget>[
            ...
            TextButton(
              ...
              onPressed: () async {
                try {
                  await FirebaseFirestore.instance.collection('figuras').doc(articulo['id']).update({
