...
import 'package:monstergeek/Figuras/AgregarFigura.dart';
import 'package:monstergeek/Figuras/EditarFigura.dart';
import 'package:monstergeek/Figuras/EliminarFigura.dart';
...
void main() async {
  ...
  runApp(AdministrarFigura());
}


class Administrarfigura extends StatelessWidget {
  @override
  ...
  Widget _buildInventoryOptions(BuildContext context) {
    return Center(
      child: Row(
        ...
        children: [
          Image.asset('lib/assets/groot.png', height: 300),
          SizedBox(width: 20),
          Container(
            width: 300,
            height: 350,
          ...
          Image.asset('lib/assets/grenlim.png', height: 300),
        ],
      ),
    );
  }
    ...
    return ElevatedButton(
      ...
      onPressed: () {
        if (text == 'Agregar') {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => AgregarFigura()),
          );
        }
      },
      child: Text(
    ...
    return ElevatedButton(
      ...
      onPressed: () {
        if (text == 'Eliminar') {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => EliminarFigura()),
          );
        }
      },
      child: Text(
    ...
    return ElevatedButton(
      ...
      onPressed: () {
        if (text == 'Editar') {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => EditarFigura()),
          );
        }
      },
      child: Text(
