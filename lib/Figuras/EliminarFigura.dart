...
class EliminarFigura extends StatefulWidget {
  @override
  _EliminarFiguraState createState() => _EliminarFiguraState();
}

class _EliminarFiguraState extends State<EliminarFigura> {
